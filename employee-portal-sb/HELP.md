...
* The original package name 'org.gap.medium.techblogs.employee-portal-sb' is invalid and this project uses 'org.gap.medium.techblogs.employeeportalsb' instead.
...
```
$ docker run --rm -p 8080:8080 employee-portal-sb:0.0.1-SNAPSHOT
```
